		...
		<div class="container">
										...
										<tr class="table_row">
											<td class="column-1">
												<div class="how-itemcart1">
													<img src="{{ asset('images/'.$item->model->image.'.jpg') }}" alt="{{ $item->model->name }}">
												</div>
											</td>
											<td class="column-2">
												{{ $item->model->name }}
											...
											<td class="column-4">
												<div class="wrap-num-product flex-w m-l-auto m-r-0">
													...
													<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="{{ $item->model->quantity }}">
			...
			@else
				<div class="col-lg-12 col-xl-12 m-lr-auto m-b-50">
					<h5 class="mb-2">There are no items in cart</h5>
